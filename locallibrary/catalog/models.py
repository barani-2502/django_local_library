...
class Genre(models.Model):
    ...
    name = models.CharField(
        max_length=200,
        unique=True,
        help_text="Enter book genre(Eg. Science fiction, Biography, etc.)"
    )
    ...
    class Meta:
        constraints = [
            UniqueConstraint(
                ...
                violation_error_message = 'Genere exists(case insensiive match)'
            ),
        ]
class Book(models.Model):
    ...
    summary = models.TextField(
        max_length=1000,
        help_text="Enter a description about the book"
    )
